import { expectInvalidOpcode } from './helpers/errors'
...
contract('SafeMath', () => {
  ...
  describe('add', function () {
    ...
    it('throws an error on addition overflow', async function () {
      ...
      await expectInvalidOpcode(this.safeMath.add(a, b))
    })
  })
  ...
  describe('sub', function () {
    ...
    it('throws an error if subtraction result would be negative', async function () {
      ...
      await expectInvalidOpcode(this.safeMath.sub(a, b))
    })
  })
  ...
  describe('mul', function () {
    ...
    it('throws an error on multiplication overflow', async function () {
      ...
      await expectInvalidOpcode(this.safeMath.mul(a, b))
    })
  })
  ...
  describe('div', function () {
    ...
    it('throws an error on zero division', async function () {
      ...
      await expectInvalidOpcode(this.safeMath.div(a, b))
    })
  })
})
