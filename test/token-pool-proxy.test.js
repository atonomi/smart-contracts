...
contract('Token Pool', accounts => {
  ...
  beforeEach(async () => {
    ...
    await ctx.contracts.registry.add(ctx.contracts.member.address, {from: ctx.actors.owner})
    ...
    await ctx.contracts.registry.add(ctx.contracts.settings.address, {from: ctx.actors.owner})
    ...
    await ctx.contracts.registry.add(ctx.contracts.device.address, {from: ctx.actors.owner})
